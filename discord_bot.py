...
async def help(ctx):
    ...
    embed.add_field(name='Available every time')
    embed.add_field(name='!champ <championName>', value='Details about any champion')
    embed.add_field(name='!champions', value='List available champions by role')
    embed.add_field(name='!hello', value='Greet me')
    embed.add_field(name='!help', value='List the commands')
    embed.add_field(name='!items', value='List in-game items by id, then pick one for more details')
    embed.add_field(name='!ranks', value='Ranks you can reach in ranked games')
    embed.add_field(name='!summonerSpells', value='Details about a specific summoner spell')
    embed.add_field(name='!version', value='Current version')
    embed.add_field(name='Requiring the api key to be valid')
    embed.add_field(name='!chest <championName>', value='Know if a chest is granted on a champion')
    embed.add_field(name='!history <summonerName>', value='Last 3 games of a player')
    embed.add_field(name='!status', value='Know if there are issues of the server')
    embed.add_field(name='!summoner <summonerName>', value='Profile of a player')
    embed.add_field(name='!weekly', value='List weekly free champions')
